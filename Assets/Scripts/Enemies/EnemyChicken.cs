...
public class EnemyChicken : MonoBehaviour, IKillable
{
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireSphere(playerCheck.position, 0.6f); // Adjust the radius as needed
    }
    ...
    private void CheckPlayerBehind()
    {
        ...
        Collider2D hitCollider = Physics2D.OverlapCircle(playerCheck.position, 0.6f, LayerMask.GetMask("Player", "Ground"));
